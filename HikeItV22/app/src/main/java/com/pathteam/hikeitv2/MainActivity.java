...
<<<<<<< HEAD
            ...
            hikelist.add(new HikeList("Paintsville Lake Trail", new ArrayList<hMarker>(),"A trail surrounding the lake. Easy to Medium Difficulty level. Some more text to fill space....","string"));
            hikelist.add(new HikeList("Carter Caves Hike", new ArrayList<hMarker>(),"A trail surrounding the lake. Easy to Medium Difficulty level. Some more text to fill space....","string"));
            hikelist.add(new HikeList("Cave Run Lake Trails", new ArrayList<hMarker>(),"A trail surrounding the lake. Easy to Medium Difficulty level. Some more text to fill space....","string"));
...
=======
            ...
            //this adds a few points to each of our hikes in our list.
>>>>>>> master
>>>>>>> 35258646dc6610169e316b7fdc81f59b31c3494c
